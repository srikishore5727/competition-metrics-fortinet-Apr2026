...
// SASE full data - Jul 2025 to Apr 2026 (10 months)
const TOTAL_KEYWORDS_DATA_INITIAL = {
  fortinet:    [184, 202, 186, 175, 181, 189, 196, 193, 193, 183],
  cisco:       [180, 185, 154, 129, 144, 154, 160, 164, 166, 142],
  hpe:         [ 98,  83,  37,  33,  45,  65,  70,  65,  52,  18],
  paloalto:    [187, 202, 189, 179, 182, 195, 200, 200, 196, 198],
  checkpoint:  [150, 170, 101,  65,  99, 114, 114, 105, 102,  61],
  crowdstrike: [0, 0, 0, 0, 35, 44, 48, 40, 40,  27],
  catonetworks:[0, 0, 0, 0, 0, 205, 207, 171, 136, 130],
  sentinelone: [0, 0, 0, 0, 0, 51, 53, 49, 47,  20],
  wiz:         [null, null, null, null, null, null, null, null, 9, 0], // Mar 2026 only
};

const CUMULATIVE_TRAFFIC_DATA_INITIAL = {
  fortinet:    [13499, 15964, 9684, 11031, 8746, 10024, 10015, 10369, 6899, 8455],
  cisco:       [ 1713,  2353, 1932,  1921, 2090,  1976,  2109,  3539, 2249, 2212],
  hpe:         [  125,    80,  181,   227,  107,   137,   118,   189,  141,   88],
  paloalto:    [ 7562,  8242, 8130,  8998, 9442, 10263, 10660, 10161, 10645, 8979],
  checkpoint:  [  671,   849,  780,   818, 1270,  1368,  1372,  1472, 1118, 1024],
  crowdstrike: [0, 0, 0, 0, 325, 423, 436, 472, 469, 487],
  catonetworks:[0, 0, 0, 0, 0, 2456, 2410, 2352, 2056, 1803],
  sentinelone: [0, 0, 0, 0, 0, 43, 38, 53, 66,  68],
  wiz:         [null, null, null, null, null, null, null, null, 0, 0], // Mar 2026 only
};

const PAGE_ONE_KEYWORDS_DATA_INITIAL = {
  fortinet:    [148, 161, 169, 165, 167, 179, 188, 179, 184, 178],
  cisco:       [102, 107, 120, 114, 128, 128, 131, 124, 136, 132],
  hpe:         [  5,   9,   7,  14,  13,  16,  15,  12,   9,  11],
  paloalto:    [157, 160, 173, 173, 174, 182, 188, 190, 188, 197],
  checkpoint:  [ 13,  28,  32,  37,  54,  57,  52,  46,  47,  42],
  crowdstrike: [0, 0, 0, 0, 17, 15, 13, 14, 19,  16],
  catonetworks:[0, 0, 0, 0, 0, 186, 185, 147, 124, 117],
  sentinelone: [0, 0, 0, 0, 0, 11, 11, 7, 10,   7],
  wiz:         [null, null, null, null, null, null, null, null, 0, 0], // Mar 2026 only
};

const AIO_DATA_INITIAL = {
  fortinet:    [148, 161, 169, 165, 167, 179, 188, 179, 136, 133],
  cisco:       [102, 107, 120, 114, 128, 128, 131, 124, 120, 100],
  hpe:         [  5,   9,   7,  14,  13,  16,  15,  12,  43,  15],
  paloalto:    [157, 160, 173, 173, 174, 182, 188, 190, 135, 137],
  checkpoint:  [ 13,  28,  32,  37,  54,  57,  52,  46,  78,  48],
  crowdstrike: [0, 0, 0, 0, 17, 15, 13, 14, 32,  24],
  catonetworks:[0, 0, 0, 0, 0, 186, 185, 147, 95,  89],
  sentinelone: [0, 0, 0, 0, 0, 11, 11, 7, 40,  18],
  wiz:         [null, null, null, null, null, null, null, null, 5, 0], // Mar 2026 only
};
        ...
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="error"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, keywords slightly declined 184 → 183 (−0.5%), trailing Palo Alto 198."
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Cisco declined 180 → 142 (−21.1%), Palo Alto grew 187 → 198 (+5.9%)."
            />
          </InsightsSection>
        );
      case 'page-one':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, page-1 keywords grew 148 → 178 (+20.3%), closely trailing Palo Alto 197."
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Palo Alto grew 157 → 197 (+25.5%), leading all competitors."
            />
          </InsightsSection>
        );
      case 'traffic':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="error"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, traffic declined 13,499 → 8,455 (−37.4%), trailing Palo Alto 8,979."
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Palo Alto grew 7,562 → 8,979 (+18.7%), leading all competitors."
            />
          </InsightsSection>
        );
      case 'aio':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="error"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, AIO declined 148 → 133 (−10.1%), trailing Palo Alto 137."
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Cisco declined 102 → 100 (−2.0%), Palo Alto declined 157 → 137 (−12.7%)."
            />
          </InsightsSection>
        );
      default:
