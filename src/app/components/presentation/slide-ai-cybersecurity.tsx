...
import { Shield, TrendingUp, TrendingDown, Zap, Sparkles, Bot } from 'lucide-react';
...
// Note: AI CyberSecurity data starts from Dec 2025
const TOTAL_KEYWORDS_DATA_INITIAL = {
  fortinet:    [null, null, null, null, null, 32, 31, 33, 29, 13],
  cisco:       [null, null, null, null, null, 29, 32, 32, 25,  4],
  hpe:         [null, null, null, null, null,  1,  6,  6,  5,  2],
  paloalto:    [null, null, null, null, null, 35, 41, 41, 31, 19],
  checkpoint:  [null, null, null, null, null, 28, 27, 27, 22, 15],
  crowdstrike: [null, null, null, null, null, 34, 31, 31, 25, 11],
  catonetworks:[null, null, null, null, null,  9, 15, 15,  7,  0],
  sentinelone: [null, null, null, null, null, 43, 45, 40, 36, 30],
  wiz:         [null, null, null, null, null, null, null, null, 24, 16], // Mar 2026 only
};

const CUMULATIVE_TRAFFIC_DATA_INITIAL = {
  fortinet:    [null, null, null, null, null,  959, 1661, 1435,  931, 1840],
  cisco:       [null, null, null, null, null,  125,  149,  141,  150,   10],
  hpe:         [null, null, null, null, null,    0,   13,    0,    1,    0],
  paloalto:    [null, null, null, null, null, 1252, 1430,  834, 1224, 1585],
  checkpoint:  [null, null, null, null, null,  301,  294,  207,  216,  612],
  crowdstrike: [null, null, null, null, null,  154,  142,  144,  125,  154],
  catonetworks:[null, null, null, null, null,    0,    0,    0,    0,    0],
  sentinelone: [null, null, null, null, null,  659,  624, 1064,  985, 1028],
  wiz:         [null, null, null, null, null, null, null, null, 1405, 1397], // Mar 2026 only
};

const PAGE_ONE_KEYWORDS_DATA_INITIAL = {
  fortinet:    [null, null, null, null, null, 10,  7, 11,  9,  5],
  cisco:       [null, null, null, null, null,  1,  3,  4,  6,  1],
  hpe:         [null, null, null, null, null,  0,  0, null, 1, 0],
  paloalto:    [null, null, null, null, null, 17, 18, 20, 20, 15],
  checkpoint:  [null, null, null, null, null,  2,  2,  8,  9,  9],
  crowdstrike: [null, null, null, null, null,  8,  7,  7,  7,  6],
  catonetworks:[null, null, null, null, null, null, null, null, null, null],
  sentinelone: [null, null, null, null, null, 26, 24, 23, 24, 23],
  wiz:         [null, null, null, null, null, null, null, null, 12, 11], // Mar 2026 only
};

const AIO_DATA_INITIAL = {
  fortinet:    [null, null, null, null, null, 26, 24, 27, 26, 10],
  cisco:       [null, null, null, null, null, 23, 24, 27, 23,  4],
  hpe:         [null, null, null, null, null,  1,  5,  4,  5,  2],
  paloalto:    [null, null, null, null, null, 27, 28, 33, 28, 15],
  checkpoint:  [null, null, null, null, null, 25, 22, 24, 22, 13],
  crowdstrike: [null, null, null, null, null, 24, 22, 26, 23,  8],
  catonetworks:[null, null, null, null, null,  7, 13, 12,  5,  0],
  sentinelone: [null, null, null, null, null, 32, 33, 34, 31, 25],
  wiz:         [null, null, null, null, null, null, null, null, 18, 13], // Mar 2026 only
};
...
export function SlideAICyberSecurity({ onNavigateHome }: { onNavigateHome?: () => void }) {
        ...
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Dec 2025 to Feb 2026, keywords slightly increased 32 → 33."
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content="From Dec 2025 to Feb 2026, Palo Alto keywords increased 35 → 41."
            />
          </InsightsSection>
        );
      case 'page-one':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Dec 2025 to Feb 2026, page-1 rankings improved 10 → 11."
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content="From Dec 2025 to Feb 2026, Palo Alto page-1 rankings improved 17 → 20."
            />
          </InsightsSection>
        );
      case 'traffic':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Dec 2025 to Feb 2026, traffic grew 959 → 1,435 (+49.6%), securing the lead."
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content="From Dec 2025 to Feb 2026, SentinelOne surged 659 → 1,064 (+61.5%), closing the gap."
            />
          </InsightsSection>
        );
      case 'aio':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Dec 2025 to Feb 2026, AIO rankings improved 26 → 27."
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content="From Dec 2025 to Feb 2026, Palo Alto AIO rankings increased 27 → 33."
            />
          </InsightsSection>
        );
      default:
  ...
  const renderChart = () => {
    ...
    return (
      <ResponsiveContainer key={`bar-${activeTab}-${Array.from(visibleVendors).sort().join('-')}-${Date.now()}`} width="100%" height="100%">
        <BarChart id={`ai-cyber-${activeTab}-bar`} data={chartData} margin={CHART_CONFIG.margin}>
          <CartesianGrid {...CHART_CONFIG.cartesianGrid} />
          <XAxis dataKey="month" {...CHART_CONFIG.xAxis} tickFormatter={formatMonth} />
  ...
  return (
    <SlideContainer slideNumber={15} onNavigateHome={onNavigateHome} source="Ahrefs">
      <SlideHeader 
        title="AI CyberSecurity" 
        subtitle="(Dec 2025 - Apr 2026)"
      />
      ...
      {!isEditing ? (
        ...
        <div className="flex-1 overflow-auto">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h3 className="text-sm font-bold text-gray-900 mb-4">Edit AI CyberSecurity Metrics Data (Dec 2025 - Feb 2026)</h3>
