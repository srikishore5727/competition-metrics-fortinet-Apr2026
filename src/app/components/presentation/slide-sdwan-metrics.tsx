...
const TOTAL_KEYWORDS_DATA_INITIAL = {
  fortinet:    [309, 362, 307, 288, 289, 295, 304, 293, 287, 273],
  cisco:       [316, 354, 315, 297, 308, 306, 314, 329, 317, 316],
  hpe:         [168, 185, 138, 127, 135, 128, 125, 124, 107,  75],
  paloalto:    [309, 357, 314, 283, 291, 309, 312, 306, 297, 305],
  checkpoint:  [222, 236,  91,  48,  65,  68,  79,  74,  71,  50],
  crowdstrike: [null, null, null, null, 0, 1, 1, 0, 0, 0], // Data starts Nov 2025
  catonetworks:[null, null, null, null, null, 185, 179, 132, 117, 82], // Data starts Dec 2025
  sentinelone: [null, null, null, null, null, 1, 2, 2, 1, 0], // Data starts Dec 2025
  wiz:         [null, null, null, null, null, null, null, null, 0, 0], // Mar 2026 only
};

const CUMULATIVE_TRAFFIC_DATA_INITIAL = {
  fortinet:    [4029, 5416, 6311, 5961, 5984, 6055, 6196, 5974, 7113, 6425],
  cisco:       [8246, 10236, 10316, 9702, 9574, 8833, 8824, 11169, 8474, 9640],
  hpe:         [1674, 1545, 1737, 1584, 1554, 1538, 1138, 1061, 900, 790],
  paloalto:    [7517, 7150, 7080, 6979, 7379, 8021, 8281, 8073, 8398, 8621],
  checkpoint:  [ 217,  183,  163,   98,  262,  167,  215,  249, 209, 345],
  crowdstrike: [null, null, null, null, 0, 0, 0, 0, 0, 0], // Data starts Nov 2025
  catonetworks:[null, null, null, null, null, 1118, 1074, 1108, 964, 563], // Data starts Dec 2025
  sentinelone: [null, null, null, null, null, 0, 0, 0, 0, 0], // Data starts Dec 2025
  wiz:         [null, null, null, null, null, null, null, null, 0, 0], // Mar 2026 only
};

const PAGE_ONE_KEYWORDS_DATA_INITIAL = {
  fortinet:    [205, 257, 271, 277, 282, 284, 292, 277, 276, 272],
  cisco:       [249, 278, 292, 284, 296, 289, 291, 309, 295, 306],
  hpe:         [ 89, 108, 110, 107, 124, 106, 105, 103,  88,  62],
  paloalto:    [236, 270, 286, 274, 277, 296, 302, 293, 285, 302],
  checkpoint:  [ 21,  16,  18,  16,  29,  22,  24,  24,  27,  34],
  crowdstrike: [null, null, null, null, 0, 1, 1, 0, 0, 0], // Data starts Nov 2025
  catonetworks:[null, null, null, null, null, 142, 135, 94, 88, 67], // Data starts Dec 2025
  sentinelone: [null, null, null, null, null, null, null, null, null, null], // No data in CSV
  wiz:         [null, null, null, null, null, null, null, null, 0, 0], // Mar 2026 only
};

const AIO_DATA_INITIAL = {
  fortinet:    [141, 198, 149, 142, 157, 160, 160, 155, 162, 161],
  cisco:       [146, 201, 154, 160, 164, 160, 158, 164, 174, 180],
  hpe:         [ 74, 112,  71,  62,  76,  81,  80,  76,  64,  38],
  paloalto:    [145, 201, 149, 144, 152, 162, 160, 155, 170, 174],
  checkpoint:  [113, 148,  44,  32,  54,  55,  62,  57,  55,  43],
  crowdstrike: [null, null, null, null, 0, 1, 1, 0, 0, 0], // Data starts Nov 2025
  catonetworks:[null, null, null, null, null, 107, 108, 89, 82, 57], // Data starts Dec 2025
  sentinelone: [null, null, null, null, null, 1, 2, 2, 1, 0], // Data starts Dec 2025
  wiz:         [null, null, null, null, null, null, null, null, 0, 0], // Mar 2026 only
};
        ...
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="error"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, keywords declined 309 → 273 (−11.7%), Cisco held steady 316 → 316."
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Cisco held 316 → 316 (flat), Palo Alto declined 309 → 305 (−1.3%)."
            />
          </InsightsSection>
        );
      case 'page-one':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, rankings grew 205 → 272 (+32.7%), closely trailing Cisco 306 and Palo Alto 302."
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Cisco grew 249 → 306 (+22.9%), Palo Alto grew 236 → 302 (+28.0%)."
            />
          </InsightsSection>
        );
      case 'traffic':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, traffic grew 4,029 → 6,425 (+59.5%), trailing Cisco and Palo Alto."
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Cisco grew 8,246 → 9,640 (+16.9%), Palo Alto grew 7,517 → 8,621 (+14.7%)."
            />
          </InsightsSection>
        );
      case 'aio':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, AIO grew 141 → 161 (+14.2%), closely trailing Cisco 180 and Palo Alto 174."
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Cisco grew 146 → 180 (+23.3%), Palo Alto grew 145 → 174 (+20.0%)."
            />
          </InsightsSection>
        );
      default:
      ...
      {!isEditing ? (
        ...
        <div className="flex-1 overflow-auto">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h3 className="text-sm font-bold text-gray-900 mb-4">Edit SD-WAN Metrics Data (Jul 2025 - Apr 2026)</h3>
