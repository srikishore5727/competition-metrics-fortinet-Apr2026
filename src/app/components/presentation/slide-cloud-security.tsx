...
const TOTAL_KEYWORDS_DATA_INITIAL = {
  fortinet:    [null, 538, 259, 231, 259, 299, 275, 305, 283, 217],
  cisco:       [null, 471, 177, 127, 137, 165, 157, 167, 163,  72],
  hpe:         [null,  64,  22,  19,  20,  19,  20,  26,  25,  17],
  paloalto:    [null, 502, 265, 203, 219, 254, 239, 277, 263, 164],
  checkpoint:  [null, 552, 293, 237, 223, 215, 208, 221, 201, 122],
  crowdstrike: [null, null, null, null, 303, 323, 290, 317, 307, 209],
  catonetworks:[null, null, null, null, null, 41, 41, 49, 44,  16],
  sentinelone: [null, null, null, null, null, 376, 376, 370, 392, 335],
  wiz:         [null, null, null, null, null, null, null, null, 334, 212], // Mar 2026 only
};

const CUMULATIVE_TRAFFIC_DATA_INITIAL = {
  fortinet:    [null, 13433, 25775, 13737, 144268, 48266, 48119, 138334, 58925, 111438],
  cisco:       [null,   633,   450,  1008,    633,   734,   821,   1550, 24224,   1373],
  hpe:         [null,   267,   279,   380,    458,   840,   407,    947,  1102,   1263],
  paloalto:    [null, 118654, 90426, 29305, 178295, 171256, 213347, 71718, 4870,   4921],
  checkpoint:  [null, 367241, 224793, 74645, 5634, 5246, 3393, 24300, 2231,   1837],
  crowdstrike: [null, null, null, null, 62044, 114510, 176313, 19111, 10645,   8802],
  catonetworks:[null, null, null, null, null, 34, 36, 59, 103,     94],
  sentinelone: [null, null, null, null, null, 25634, 15386, 226115, 17605,  18679],
  wiz:         [null, null, null, null, null, null, null, null, 16086,  13060], // Mar 2026 only
};

const PAGE_ONE_KEYWORDS_DATA_INITIAL = {
  fortinet:    [null, 109, 142, 163, 179, 199, 173, 206, 211, 173],
  cisco:       [null,  58,  47,  57,  48,  49,  38,  47,  64,  37],
  hpe:         [null,  11,  11,  11,  14,   9,   9,  10,  14,  12],
  paloalto:    [null, 143, 150, 149, 149, 164, 138, 174, 185, 137],
  checkpoint:  [null, 179, 177, 175, 142,  91,  86,  87,  87,  69],
  crowdstrike: [null, null, null, null, 249, 234, 198, 223, 210, 164],
  catonetworks:[null, null, null, null, null, 7, 6, 10, 10,   9],
  sentinelone: [null, null, null, null, null, 320, 317, 318, 350, 314],
  wiz:         [null, null, null, null, null, null, null, null, 272, 178], // Mar 2026 only
};

const AIO_DATA_INITIAL = {
  fortinet:    [null, 181,  91, 104, 143, 180, 180, 190, 192, 131],
  cisco:       [null, 142,  51,  48,  95, 121, 118, 122, 127,  48],
  hpe:         [null,  14,  10,   7,  15,  16,  18,  23,  20,  10],
  paloalto:    [null, 164,  89,  77, 115, 140, 153, 165, 173,  92],
  checkpoint:  [null, 181, 116, 118, 138, 151, 152, 156, 152,  86],
  crowdstrike: [null, null, null, null, 149, 179, 182, 191, 200, 124],
  catonetworks:[null, null, null, null, null, 38, 39, 42, 36,  13],
  sentinelone: [null, null, null, null, null, 210, 207, 203, 236, 194],
  wiz:         [null, null, null, null, null, null, null, null, 203, 133], // Mar 2026 only
};
        ...
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="error"
              title="Fortinet"
              content="From Aug 2025 to Apr 2026, keywords declined 538 → 217 (−59.7%), SentinelOne leads at 335."
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content="From Aug 2025 to Apr 2026, Palo Alto declined 502 → 164 (−67.3%), SentinelOne grew to 335."
            />
          </InsightsSection>
        );
      case 'page-one':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Aug 2025 to Apr 2026, page-1 keywords grew 109 → 173 (+58.7%), trailing SentinelOne 314."
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content="From Aug 2025 to Apr 2026, Palo Alto declined 143 → 137 (−4.2%), SentinelOne leads at 314."
            />
          </InsightsSection>
        );
      case 'traffic':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Aug 2025 to Apr 2026, traffic surged 13,433 → 111,438 (+730%), leading all competitors."
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content="From Aug 2025 to Apr 2026, Palo Alto plummeted 118,654 → 4,921 (−96%), SentinelOne at 18,679."
            />
          </InsightsSection>
        );
      case 'aio':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="error"
              title="Fortinet"
              content="From Aug 2025 to Apr 2026, AIO declined 181 → 131 (−27.6%), trailing SentinelOne 194 and Wiz 133."
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content="From Aug 2025 to Apr 2026, Palo Alto declined 164 → 92 (−43.9%), SentinelOne leads at 194."
            />
          </InsightsSection>
        );
      default:
