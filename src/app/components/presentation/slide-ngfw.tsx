...
const TOTAL_KEYWORDS_ABS = {
  fortinet:    [1240, 1421, 995, 896, 944, 981, 998, 999,  908, 903],
  cisco:       [1132, 1177, 756, 665, 700, 742, 755, 825,  689, 654],
  hpe:         [ 170,  174,  87,  85, 103, 102, 109, 109,  111,  72],
  paloalto:    [1129, 1224, 848, 727, 756, 860, 909, 917,  868, 809],
  checkpoint:  [1115, 1198, 708, 564, 560, 562, 562, 567,  553, 516],
  crowdstrike: [null, null, null, null,  63,  74,  80,  89,   76,  61], // Data starts Nov 2025
  catonetworks:[null, null, null, null, null,  89,  99,  86,   77,  38], // Data starts Dec 2025
  sentinelone: [null, null, null, null, null,  25,  32,  34,   31,  17], // Data starts Dec 2025
  wiz:         [null, null, null, null, null, null, null, null, 14,   0], // Data starts Mar 2026
};

const PAGE_ONE_KW_ABS = {
  fortinet:    [653, 762, 791, 788, 849, 862, 879, 859, 820, 864],
  cisco:       [494, 510, 535, 556, 584, 601, 604, 661, 562, 606],
  hpe:         [ 41,  41,  45,  51,  64,  55,  66,  63,  69,  53],
  paloalto:    [517, 557, 611, 608, 634, 719, 760, 758, 761, 746],
  checkpoint:  [425, 430, 445, 413, 400, 371, 381, 361, 378, 439],
  crowdstrike: [null, null, null, null,  38,  39,  36,  40,  35,  54], // Data starts Nov 2025
  catonetworks:[null, null, null, null, null,  22,  29,  21,  27,  22], // Data starts Dec 2025
  sentinelone: [null, null, null, null, null,   6,   7,   6,  12,  12], // Data starts Dec 2025
  wiz:         [null, null, null, null, null, null, null, null, 0,   0], // Data starts Mar 2026
};

const CUMULATIVE_TRAFFIC_ABS = {
  fortinet:    [18947, 23092, 25392, 23104, 24692, 27746, 30861, 30105, 35029, 37349],
  cisco:       [16293, 15420, 16155, 15861, 15826, 24132, 29153, 30462, 36553, 42295],
  hpe:         [  256,   413,   384,   782,   836,   626,   687,   702,   645,   518],
  paloalto:    [10265, 11043, 11770, 11946, 12637, 21611, 23649, 23938, 23938, 27038],
  checkpoint:  [ 5250,  6262,  5016,  4294,  5126,  4772,  4814,  5881,  4753,  8828],
  crowdstrike: [null, null, null, null,  407,  338,  317,  451,  296,   629], // Data starts Nov 2025
  catonetworks:[null, null, null, null, null,  270,  306,  351,  283,   214], // Data starts Dec 2025
  sentinelone: [null, null, null, null, null,   62,   60,   62,   64,    92], // Data starts Dec 2025
  wiz:         [null, null, null, null, null, null, null, null,    0,     0], // Data starts Mar 2026
};

const AIO_DATA_ABS = {
  fortinet:    [538, 611, 474, 498, 588, 615, 637, 652, 660, 678],
  cisco:       [484, 530, 374, 389, 462, 490, 498, 534, 517, 498],
  hpe:         [ 82,  98,  61,  55,  77,  77,  79,  87,  90,  56],
  paloalto:    [497, 550, 420, 413, 496, 558, 587, 613, 629, 602],
  checkpoint:  [500, 542, 359, 353, 389, 396, 384, 406, 430, 405],
  crowdstrike: [null, null, null, null,  47,  47,  53,  61,  58,  45], // Data starts Nov 2025
  catonetworks:[null, null, null, null, null,  68,  74,  73,  65,  32], // Data starts Dec 2025
  sentinelone: [null, null, null, null, null,  18,  22,  27,  27,  13], // Data starts Dec 2025
  wiz:         [null, null, null, null, null, null, null, null, 13,   0], // Data starts Mar 2026
};
        ...
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="error"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, keywords declined 1,240 → 903 (−27.2%), Wiz entered at 0."
            />
            <InsightCard
              icon={TrendingDown}
              type="error"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Cisco declined 1,132 → 654 (−42.2%), Palo Alto declined 1,129 → 809 (−28.3%)."
            />
          </InsightsSection>
        );
      case 'page-one':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, page-1 keywords grew 653 → 864 (+32.3%), leading Palo Alto 746 and Cisco 606."
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Cisco grew 494 → 606 (+22.7%), Palo Alto grew 517 → 746 (+44.3%)."
            />
          </InsightsSection>
        );
      case 'traffic':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, traffic grew 18,947 → 37,349 (+97.1%), strong performance."
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Cisco surged 16,293 → 42,295 (+159.6%), leading Fortinet since Mar."
            />
          </InsightsSection>
        );
      case 'aio':
        return (
          <InsightsSection>
            <InsightCard
              ...
              type="success"
              title="Fortinet"
              content="From Jul 2025 to Apr 2026, AIO keywords grew 538 → 678 (+26.0%), maintaining category lead."
            />
            <InsightCard
              icon={TrendingUp}
              type="success"
              title="Competitions"
              content="From Jul 2025 to Apr 2026, Cisco grew 484 → 498 (+2.9%), Palo Alto grew 497 → 602 (+21.1%)."
            />
          </InsightsSection>
        );
      default:
