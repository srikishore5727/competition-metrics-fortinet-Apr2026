      ...
      return (
        <InsightsSection>
          <InsightCard
            ...
            type="success"
            title="Fortinet"
            content="From Jul 2025 to Apr 2026, traffic grew 890K → 1.53M (+72%), Wiz held 123K → 129K (+5%)."
          />
          <InsightCard
            icon={TrendingUp}
            type="success"
            title="Competitions"
            content="From Jul 2025 to Apr 2026, Cisco leads at 2.03M (+10%), Palo Alto 296K → 622K (+110%)."
          />
        </InsightsSection>
      );
      ...
      return (
        <InsightsSection>
          <InsightCard
            ...
            type="error"
            title="Fortinet"
            content="From Jul 2025 to Apr 2026, branded traffic fell 158K → 110K (−30%), Wiz 91K → 76K (−16%)."
          />
          <InsightCard
            icon={TrendingDown}
            type="error"
            title="Competitions"
            content="From Jul 2025 to Apr 2026, Cisco fell 974K → 724K (−26%), Palo Alto 71K → 162K (+129%)."
          />
        </InsightsSection>
      );
    } else {
      return (
        <InsightsSection>
          <InsightCard
            ...
            type="success"
            title="Fortinet"
            content="From Jul 2025 to Apr 2026, non-branded grew 732K → 1.42M (+94%), Wiz 32K → 53K (+66%)."
          />
          <InsightCard
            icon={TrendingUp}
            type="success"
            title="Competitions"
            content="From Jul 2025 to Apr 2026, Cisco grew 877K → 1.31M (+49%), Palo Alto 225K → 460K (+104%)."
          />
        </InsightsSection>
      );
    }
